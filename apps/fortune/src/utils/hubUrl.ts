 ...
 * （localhost:5175）や自宅サーバの `vite preview`（100.x.x.x:4175）へ直接
...
const HUB_PORT_BY_APP_PORT: Record<string, string> = {
  '5175': '5173', // vite dev server → bin/serve.php のハブ入口ページ
  '4175': '4173', // vite preview → himatsudocmshub-landing.service
}
